...
CREATE POLICY "all_access_orders"
  ON orders
  FOR ALL
  TO public
  USING (true)
...
CREATE POLICY "all_access_order_items"
  ON order_items
  FOR ALL
  TO public
  USING (true)
...
CREATE POLICY "all_access_employees"
  ON employees
  FOR ALL
  TO public
  USING (true)
...
CREATE POLICY "all_access_shifts"
  ON shifts
  FOR ALL
  TO public
  USING (true)
...
CREATE POLICY "all_access_menu_items"
  ON menu_items
  FOR ALL
  TO public
  USING (true)
